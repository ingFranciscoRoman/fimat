...
<div id="cargar-vistas">
    <div class="card col-md-11" style="margin:auto; margin-top: 50px;">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a href="{{Session('piloto')[0]->link}}" target="_blank" id="btn_clase_linea"> 
                    <img src="{{asset('../img/boton/1.png')}}" alt="clases_vivo" id="btn_clases_vivo">
                    </a>
                </div>
                <div class="col-md-2">
                    <a href="{{Session('piloto')[0]->simulacro}}" target="_blank" id="btn_retos"> 
                    <img src="{{asset('../img/boton/2.png')}}" alt="btn_retos" id="btn_retos">
                    </a>
                </div>
                @endif 
            </div>
            @if (Session('tarjetas_piloto')!= "")
                <div class="row">
                    @for ($i = 0; $i < count(Session('tarjetas_piloto')); $i++)
                        @if (Session('tarjetas_piloto')[$i]->materia == 1)
                        <div class="col">
                            <input type="hidden" id="id_tarjeta" value="<?php print_r(Session('tarjetas_piloto')[$i]->id); ?>">
                        ...
                        @endif
                        @if (Session('tarjetas_piloto')[$i]->materia == 2)    
                            <div class="col" onclick="alertaquimica();">
                                <input type="hidden" id="id_quimica" value="<?php print_r(Session('tarjetas_piloto')[$i]->id); ?>">
                        ...
                        @endif 
                        @if (Session('tarjetas_piloto')[$i]->materia == 3)
                            <div class="col" onclick="alertafisica();">
                                <input type="hidden" id="id_fisica" value="<?php print_r(Session('tarjetas_piloto')[$i]->id); ?>">
                        ...
                        @endif
                        @if (Session('tarjetas_piloto')[$i]->materia == 4)
                            <div class="col" onclick="alertasociales();">
                                <input type="hidden" id="id_sociales" value="<?php print_r(Session('tarjetas_piloto')[$i]->id); ?>">
                        ...
                        @endif
                        @if (Session('tarjetas_piloto')[$i]->materia == 5)    
                            <div class="col" onclick="alertamatematicas();">
                                <input type="hidden" id="id_matematicas" value="<?php print_r(Session('tarjetas_piloto')[$i]->id); ?>">
                        ...
                        @endif
                        @if (Session('tarjetas_piloto')[$i]->materia == 6)    
                            <div class="col" onclick="alertaingles();">
                                <input type="hidden" id="id_ingles" value="<?php print_r(Session('tarjetas_piloto')[$i]->id); ?>">
                        ...
                        @endif
                        @if (Session('tarjetas_piloto')[$i]->materia == 7)    
                            <div class="col" onclick="alertalectura();">
                                <input type="hidden" id="id_lectura" value="<?php print_r(Session('tarjetas_piloto')[$i]->id); ?>">
